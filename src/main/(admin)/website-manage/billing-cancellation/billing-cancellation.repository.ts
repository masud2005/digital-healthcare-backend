...
export class BillingCancellationRepository {
    ...
    create(
        data:
            | Prisma.BillingCancellationCreateInput
            | Prisma.BillingCancellationUncheckedCreateInput,
    ) {
    ...
    update(
        id: string,
        data:
            | Prisma.BillingCancellationUpdateInput
            | Prisma.BillingCancellationUncheckedUpdateInput,
    ) {

...
export class AboutUsService {
        ...
        if (!record) {
            record = await this.aboutUsRepository.create({
                ...
                bodySection1Description:
                    "To deliver high-quality, compassionate care to every patient.",
                ...
                bodySection2Description:
                    "To lead the transition to digital-first healthcare solutions.",
    ...
    async update(dto: UpdateAboutUsDto) {
        ...
        const data: any = {
            ...dto,
            bodySection3Points: dto.bodySection3Points
                ? (dto.bodySection3Points as any)
                : undefined,
        ...
        if (!record) {
            ...
            record = await this.aboutUsRepository.create({
                ...
                bodySection1Description:
                    dto.bodySection1Description ||
                    "To deliver high-quality, compassionate care to every patient.",
                bodySection1ButtonText: dto.bodySection1ButtonText || "Read Mission",
                bodySection1ButtonUrl: dto.bodySection1ButtonUrl || "/mission",
                bodySection1TargetBlank:
                    dto.bodySection1TargetBlank !== undefined ? dto.bodySection1TargetBlank : true,
                ...
                bodySection2Description:
                    dto.bodySection2Description ||
                    "To lead the transition to digital-first healthcare solutions.",
                bodySection2ButtonText: dto.bodySection2ButtonText || "Read Vision",
                bodySection2ButtonUrl: dto.bodySection2ButtonUrl || "/vision",
                bodySection2TargetBlank:
                    dto.bodySection2TargetBlank !== undefined ? dto.bodySection2TargetBlank : true,
                ...
                bodySection3Description:
                    dto.bodySection3Description || "How we started and where we are today.",
                bodySection3Points: dto.bodySection3Points
                    ? (dto.bodySection3Points as any)
                    : ["Founded in 2020", "Served over 10,000 patients", "24/7 care support team"],
                bodySection3ButtonText: dto.bodySection3ButtonText || "Read Story",
                bodySection3ButtonUrl: dto.bodySection3ButtonUrl || "/story",
                bodySection3TargetBlank:
                    dto.bodySection3TargetBlank !== undefined ? dto.bodySection3TargetBlank : true,

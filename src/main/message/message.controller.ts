...
export class MessageController {
    ...
    async getPublicKey(@Param("userId") userId: string) {
        ...
        return {
            ...
            data: { userId: data.userId, publicKey: data.publicKey },
        };
    }
    ...
    @Post("conversation")
    @ApiOperation({
        summary: "Create a new conversation (both users must have registered public keys)",
    })
    ...
    @ApiOperation({
        summary: "Get all uploaded files in a conversation, grouped by patient and provider",
    })
